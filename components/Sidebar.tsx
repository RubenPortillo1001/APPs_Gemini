...
const Sidebar: React.FC<SidebarProps> = ({ activeView, setActiveView, onReset }) => {
    ...
    const navItems: { id: View; label: string; icon: React.ReactElement }[] = [
        ...
        { id: 'demographics', label: 'Análisis Demográfico', icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path d="M9 6a3 3 0 11-6 0 3 3 0 016 0zm-1.75 7.111a.75.75 0 00-1.06 1.06l1.06-1.06zM16.25 19.75a.75.75 0 101.5 0h-1.5zM12.5 13.25a.75.75 0 00-1.5 0h1.5zM18.75 13.25a.75.75 0 00-1.5 0h1.5zM14 13.25a.75.75 0 00-1.5 0h1.5zM16.25 14.75a.75.75 0 001.5 0h-1.5zM18 14.75a.75.75 0 001.5 0h-1.5zM17.75 17.5a.75.75 0 00-1.5 0h1.5zM14.5 17.5a.75.75 0 00-1.5 0h1.5zM12.25 17.5a.75.75 0 00-1.5 0h1.5zM10.75 16a.75.75 0 00-1.5 0h1.5zM10 17.5a.75.75 0 00-1.5 0h1.5zM10 14.75a.75.75 0 00-1.5 0h1.5zM10 13.25a.75.75 0 00-1.5 0h1.5zM4 17.5a.75.75 0 00-1.5 0h1.5zM4 14.75a.75.75 0 00-1.5 0h1.5zM4 13.25a.75.75 0 00-1.5 0h1.5z" /></svg> },
        ...
        { id: 'reports', label: 'Generar Informes', icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M6 2a2 2 0 00-2 2v12a2 2 0 002 2h8a2 2 0 002-2V7.414A2 2 0 0015.414 6L12 2.586A2 2 0 0010.586 2H6zm5 6a1 1 0 10-2 0v3.586l-1.293-1.293a1 1 0 10-1.414 1.414l3 3a1 1 0 001.414 0l3-3a1 1 0 00-1.414-1.414L11 11.586V8z" clipRule="evenodd" /></svg> },
    ];
    
    return (
        <aside className="no-print w-64 bg-sidebar text-sidebar-text flex flex-col">
            <div className="p-4 border-b border-gray-700 flex flex-col items-center">
                 <img src="https://www.mdp.gov.py/wp-content/uploads/2022/10/1-LOGO-MDP-PRINCIPAL-810x1024.png" alt="Logo Ministerio de la Defensa Pública" className="h-24 w-auto mb-4"/>
                <h2 className="text-xl font-semibold text-white text-center">Panel de Análisis</h2>
            </div>
            ...
            <div className="p-4 border-t border-gray-700">
                 <button
                    onClick={onReset}
                    className="w-full flex items-center justify-center px-4 py-2 text-sm font-medium rounded-md bg-red-600 text-white hover:bg-red-700 transition-colors"
                >
